...
check$summarize <- function() {
  ...
  if (check$part()) {
    check$parts[[check$part.counter]]$token <- 'eyJ1c2VyIjoyNjAyLCJwYXJ0IjoxNzk3NH0:1gFZL6:TbZW2Cze_W9fv_4j0q1YRd4lcGQ'
    tryCatch({
  ...
  if (check$part()) {
    check$parts[[check$part.counter]]$token <- 'eyJ1c2VyIjoyNjAyLCJwYXJ0IjoxNzk3NX0:1gFZL6:3VuQgiVGmfh7tmZaPrZm9Gx1WTE'
    tryCatch({
