...
check$summarize <- function() {
  ...
  if (check$part()) {
    check$parts[[check$part.counter]]$token <- 'eyJwYXJ0IjoxNzk2NiwidXNlciI6MjYwMn0:1gD1wz:wXBeE2JioGUgf83EDJtOpz7Na0I'
    tryCatch({
  ...
  if (check$part()) {
    check$parts[[check$part.counter]]$token <- 'eyJwYXJ0IjoxNzk2NywidXNlciI6MjYwMn0:1gD1wz:E8HiSNdTa8_rTPfQ3n7CCCfPjuU'
    tryCatch({
  ...
  if (check$part()) {
    check$parts[[check$part.counter]]$token <- 'eyJwYXJ0IjoxNzk2OCwidXNlciI6MjYwMn0:1gD1wz:Rq2e7ZAct8Z9jxl9MoFwa_P_uuI'
    tryCatch({
